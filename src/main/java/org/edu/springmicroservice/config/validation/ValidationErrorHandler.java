...
public class ValidationErrorHandler {
    ...
    public List<ErrorDTO> handler(MethodArgumentNotValidException exception) {
        ...
        return fieldErrors.stream().map(fieldError -> new ErrorDTO(fieldError.getField(), messageSource.getMessage(fieldError, LocaleContextHolder.getLocale()))).collect(Collectors.toList());
    }
}
